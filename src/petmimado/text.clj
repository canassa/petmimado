...
(def text
  {:home-title-1 "Serviço Personalizado"
   ...
   :gromming "Tosa"
   :gromming-description ["Pet Mimado oferece várias opções diferentes para o seu pet obter um estilo completo. Os cortes padrão da raça estão disponíveis ou então você pode escolher o seu próprio corte ou algo mais fashion. Lembre-se, o corte escolhido deve ser algo que se adequa ao seu estilo de vida e personalidade!"]
   :gromming-short-description "Os cortes padrão da raça estão disponíveis ou então você pode escolher o seu próprio corte ou algo mais fashion..."
